...
<div class="get-prompt-key">
	...
	<h2><?php _e( 'Before we get started you need to choose a plan and get a Postmatic API key.', 'Postmatic' ); ?></h2>
	...
	<p>
		<a href="<?php echo $new_site_url; ?>" target="_blank" class="button button-primary button-large"><?php _e( 'Get an API key', 'Postmatic' ); ?></a>
	</p>
